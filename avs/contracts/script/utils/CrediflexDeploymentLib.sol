...
import {CrediflexServiceManager} from "../../src/CrediflexServiceManager.sol";
...
library CrediflexDeploymentLib {
    using stdJson for *;
    using Strings for *;
    ...
    function deployContracts(
        ...
        result.crediflexServiceManager = UpgradeableProxyLib.setUpEmptyProxy(proxyAdmin);
        result.stakeRegistry = UpgradeableProxyLib.setUpEmptyProxy(proxyAdmin);
        // Deploy the implementation contracts, using the proxy contracts as inputs
        address stakeRegistryImpl =
            address(new ECDSAStakeRegistry(IDelegationManager(core.delegationManager)));
        address crediflexServiceManagerImpl = address(
            new CrediflexServiceManager(
                core.avsDirectory,
        ...
        bytes memory upgradeCall = abi.encodeCall(
            ECDSAStakeRegistry.initialize, (result.crediflexServiceManager, 0, quorum)
        );
        UpgradeableProxyLib.upgradeAndCall(result.stakeRegistry, stakeRegistryImpl, upgradeCall);
        UpgradeableProxyLib.upgrade(result.crediflexServiceManager, crediflexServiceManagerImpl);
    ...
    function readDeploymentJson(
        ...
        data.crediflexServiceManager = json.readAddress(".contracts.crediflexServiceManager");
    ...
    function writeDeploymentJson(DeploymentData memory data) internal {
        writeDeploymentJson("deployments/crediflex/", block.chainid, data);
    }
    ...
    function writeDeploymentJson(
        ...
        address proxyAdmin =
            address(UpgradeableProxyLib.getProxyAdmin(data.crediflexServiceManager));
    ...
    function _generateContractsJson(
        ...
        return string.concat(
            ...
            data.crediflexServiceManager.toHexString(),
            '","crediflexServiceManagerImpl":"',
            data.crediflexServiceManager.getImplementation().toHexString(),
            '","stakeRegistry":"',
